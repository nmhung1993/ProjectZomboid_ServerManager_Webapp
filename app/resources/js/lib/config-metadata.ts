...
export const SANDBOX_META: Record<string, SettingMeta> = {
    ...
    StartYear: {
        type: 'enum',
        group: 'Time & Start',
        description: 'Starting year of the game world (PZ B42 enum: 1 = 1993, 2 = 1994, 3 = 1995, etc.).',
        default: 1,
        options: [
            { value: '1', label: '1993 (Year 1)' },
            { value: '2', label: '1994 (Year 2)' },
            { value: '3', label: '1995 (Year 3)' },
            { value: '4', label: '1996 (Year 4)' },
            { value: '5', label: '1997 (Year 5)' },
            { value: '6', label: '1998 (Year 6)' },
            { value: '7', label: '1999 (Year 7)' },
            { value: '8', label: '2000 (Year 8)' },
            { value: '9', label: '2001 (Year 9)' },
            { value: '10', label: '2002 (Year 10)' },
            { value: '11', label: '2003 (Year 11)' },
            { value: '12', label: '2004 (Year 12)' },
            { value: '13', label: '2005 (Year 13)' },
            { value: '14', label: '2006 (Year 14)' },
            { value: '15', label: '2007 (Year 15)' },
            { value: '16', label: '2008 (Year 16)' },
            { value: '17', label: '2009 (Year 17)' },
            { value: '18', label: '2010 (Year 18)' },
            { value: '19', label: '2011 (Year 19)' },
            { value: '20', label: '2012 (Year 20)' },
            { value: '21', label: '2013 (Year 21)' },
            { value: '22', label: '2014 (Year 22)' },
            { value: '23', label: '2015 (Year 23)' },
            { value: '24', label: '2016 (Year 24)' },
            { value: '25', label: '2017 (Year 25)' },
            { value: '26', label: '2018 (Year 26)' },
            { value: '27', label: '2019 (Year 27)' },
            { value: '28', label: '2020 (Year 28)' },
            { value: '29', label: '2021 (Year 29)' },
            { value: '30', label: '2022 (Year 30)' },
            { value: '31', label: '2023 (Year 31)' },
            { value: '32', label: '2024 (Year 32)' },
            { value: '33', label: '2025 (Year 33)' },
            { value: '34', label: '2026 (Year 34)' },
            { value: '35', label: '2027 (Year 35)' },
            { value: '36', label: '2028 (Year 36)' },
            { value: '37', label: '2029 (Year 37)' },
            { value: '38', label: '2030 (Year 38)' },
            { value: '39', label: '2031 (Year 39)' },
            { value: '40', label: '2032 (Year 40)' },
        ],
    },
    StartMonth: {
        type: 'number',
