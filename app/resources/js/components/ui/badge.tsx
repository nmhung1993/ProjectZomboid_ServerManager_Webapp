  ...
  "inline-flex items-center justify-center rounded-lg border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        ...
        soft:
          "border-transparent bg-accent/60 text-accent-foreground [a&]:hover:bg-accent",
        success:
          "border-transparent bg-success/15 text-emerald-700 dark:text-emerald-300 [a&]:hover:bg-success/25",
        warning:
          "border-transparent bg-warning/15 text-amber-700 dark:text-amber-300 [a&]:hover:bg-warning/25",
        info:
          "border-transparent bg-info/15 text-cyan-700 dark:text-cyan-300 [a&]:hover:bg-info/25",
      },
    },
    defaultVariants: {
      variant: "default",
