...
class DiscordBotService
{
    ...
    private const ACTION_CONFIG = [
        ...
        'server.autorestart.upcoming' => ['color' => 0x3498DB, 'emoji' => "\u{1F514}", 'title' => 'Upcoming Restart'],
        'server.autorestart.scheduled' => ['color' => 0xE67E22, 'emoji' => "\u{23F0}", 'title' => 'Auto-Restart Scheduled'],
     ...
     * @param  string|null  $threadId  Optional thread ID to reply in
     * @param  array<int, string>  $roleIds  Role IDs to mention
     */
    ...
    public function sendTestMessage(
        ...
        $embed = [
            'title' => "\u{1F916} Bot Test",
            'description' => 'Discord bot integration is working correctly!',
            'color' => 0x2ECC71,
            'footer' => [
                'text' => config('app.name', 'PZ Server'),
            ],
    ...
    {
        // If a thread ID is provided, reply within that thread.
